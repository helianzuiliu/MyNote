...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			div6 = element("div");
			h40 = element("h4");
			h40.textContent = "Markdown 状态栏";
			t1 = space();
			p0 = element("p");
			p0.textContent = "在这里可以自定义编辑 Markdown 笔记时状态栏上显示的统计信息.";
			t3 = space();
			div2 = element("div");
			...
			t8 = space();
			h41 = element("h4");
			h41.textContent = "替换状态栏";
			t10 = space();
			p1 = element("p");
			p1.textContent = "在这里可以自定义在非编辑 Markdown 文件时状态栏显示的统计信息.";
			t12 = space();
			div5 = element("div");
...
class BetterWordCountSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.empty();
        containerEl.createEl("h3", { text: "更好的字数统计设置" });
        // General Settings
        containerEl.createEl("h4", { text: "常规设置" });
        new obsidian.Setting(containerEl)
            .setName("收集统计信息")
            .setDesc("需要重新加载以使更改生效。打开以开始收集您的每日写作统计。存储在下面指定的路径中。这是进行当日计数和总计数所必需的。")
            .addToggle((cb) => {
        ...
        new obsidian.Setting(containerEl)
            .setName("不要计算评论")
            .setDesc("如果你不希望计算markdown评论，请打开此选项。")
            .addToggle((cb) => {
        ...
        new obsidian.Setting(containerEl)
            .setName("显示节字数统计")
            .setDesc("如果你想在标题旁边显示节的字数，请打开此选项。")
            .addToggle((cb) => {
        ...
        // Advanced Settings
        containerEl.createEl("h4", { text: "高级设置" });
        new obsidian.Setting(containerEl)
            .setName("仓库统计文件路径")
            .setDesc("更改生效需要重新加载。保险库统计文件相对于保险库根目录的位置。")
            .addText((text) => {
